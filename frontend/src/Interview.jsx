...
export default function Interview({ orgId }) {
  ...
  if (!started) return (
    <div style={{ maxWidth: '480px', margin: '0 auto', padding: '48px 20px', textAlign: 'center' }}>
      ...
      <div style={{ width: '52px', height: '52px', borderRadius: '50%', background: '#EEEDFE', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 20px' }}>
      ...
      <h2 style={{ fontSize: '22px', fontWeight: '600', marginBottom: '10px' }}>Narratives Interview</h2>
      <p style={{ color: '#666', fontSize: '14px', maxWidth: '360px', margin: '0 auto 24px', lineHeight: '1.7' }}>
        Ein KI-Bot begleitet Sie durch ein Gespräch über Ihre Erfahrungen in der Organisation. Vollständig anonym · Keine richtigen oder falschen Antworten.
      </p>
      <div style={{ marginBottom: '28px', textAlign: 'left', maxWidth: '280px', margin: '0 auto 28px' }}>
      ...
      <button onClick={startInterview}
        style={{ width: '100%', maxWidth: '280px', padding: '14px', background: '#534AB7', color: '#fff', border: 'none', borderRadius: '12px', fontSize: '16px', fontWeight: '500', cursor: 'pointer', fontFamily: 'inherit' }}>
        Interview starten
      </button>
    </div>
  );
